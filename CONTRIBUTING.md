...
method is to [create an issue](https://github.com/cisagov/log4j-scan/issues) in this
...
If you would like to submit a pull request, please submit it [here](https://github.com/cisagov/log4j-scan/pulls).
